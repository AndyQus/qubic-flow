export const de = {
  ...
  nav: { dashboard: 'Dashboard', wallets: 'Wallets', nodes: 'Nodes', stats: 'Statistiken', settings: 'Einstellungen' },
  ...
  settings: { animation: 'Animation', theme: 'Theme', dark: 'Dunkel', light: 'Hell', language: 'Sprache', push_down: 'Push Down', slide_in: 'Slide In', beam_drop: 'Beam Drop' },
